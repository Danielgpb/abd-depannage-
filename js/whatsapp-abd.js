...
(function() {
              ...
              <div class="wa-address-input-container">
                <div class="wa-text-input-container">
                  <input
                    ...
                    autocomplete="off"
                  />
                  <button class="wa-text-submit-btn" id="wa-address-submit">
                    ${ICONS.chevronRight}
                  </button>
                </div>
            ...
            <div class="wa-address-input-container">
              <div class="wa-text-input-container">
                <input
                  ...
                  autocomplete="off"
                />
                <button class="wa-text-submit-btn" id="wa-destination-submit">
                  ${ICONS.chevronRight}
                </button>
              </div>
  ...
  function attachStepEvents() {
    ...
    // Manual address submission (Enter or submit button)
    const addressInput = document.getElementById('wa-address-input');
    const addressSubmit = document.getElementById('wa-address-submit');
    if (addressInput && addressSubmit) {
      const submitAddress = () => {
      ...
      addressSubmit.addEventListener('click', submitAddress);
    ...
    const destSubmit = document.getElementById('wa-destination-submit');
    if (destInput && destSubmit) {
      const submitDest = () => {
      ...
      destSubmit.addEventListener('click', submitDest);
