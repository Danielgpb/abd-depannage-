/**
 * ========================================
 * ABD DÉPANNAGE — Formulaire WhatsApp conversationnel
 * Version : 1.0
 * Date : 2026-05-20
 *
 * Mini-chat WhatsApp pour pré-qualifier les demandes d'intervention.
 * Le visiteur clique sur le bouton WhatsApp, répond à 4-5 questions,
 * puis est redirigé vers WhatsApp avec son message déjà rédigé.
 *
 * Fonctionnalités :
 * - UI chat moderne avec bulles de conversation
 * - Adapté mobile en priorité
 * - Barre de progression d'étape
 * - 2 langues : FR (principal) + NL (Bruxelles bilingue)
 * - 5 étapes max — 6 si remorquage avec destination
 * - Messages adaptés au type de panne (batterie, démarrage, pneu, remorquage, épave, autre)
 * - Autocomplete d'adresse via Google Places + estimation distance
 * - Flux spécial pour les épaves (marque, modèle, année)
 *
 * Numéro WhatsApp : 0488 04 87 33 (équipe ABD à Schepdaal)
 * ========================================
 */
...
(function() {
  ...
  let TRANSLATIONS = {
    fr: {
      ...
      step0_bot_message: 'Bonjour ! On est disponibles 24h/24. Décrivez-nous votre problème et on vous donne un tarif sur WhatsApp, sans engagement.',

      problem_poidslourd: 'Camion / poids lourd en panne',

      // PTAC options (heavy truck weight class)
      ptac_3_5t: 'Jusqu\'à 3,5T',
      ptac_7_5t: '3,5 à 7,5T',
      ptac_12t: '7,5 à 12T',
      ptac_19t: '12 à 19T',
      ptac_26t: '19 à 26T',
      ptac_32t: '26 à 32T',
      ptac_40t: 'Semi-remorque 40T',
      ptac_over40t: 'Plus de 40T',
      summary_ptac: 'PTAC',
      msg_ptac: 'PTAC :',
      ...
      problem_locked: 'Je suis enfermé hors de ma voiture',
      problem_other: 'Autre problème',

      // Personalized responses per problem
      response_poidslourd: 'On a un camion remorqueur poids lourds 24/7, baliseur autoroute et matériel adapté (PTAC jusqu\'à 40T). Quelques infos sur votre véhicule pour le tarif.',
      ...
      response_locked: 'On vient ouvrir votre voiture avec le kit non-destructif — zéro vitre cassée, zéro dégât. Quelques infos sur votre véhicule pour le tarif.',
      ...
      // Step 1b: Wheel position (flat tire only)
      step1b_bot_question: 'Quelle roue est crevée ?',
      wheel_position_front: 'Roue avant',
      wheel_position_rear: 'Roue arrière',

      // Step Wreck / Locked / Poids lourd : Vehicle identification (brand, model, year)
      wreck_step1_bot_question: 'Quelle est la marque du véhicule ?',
      wreck_step1_input_placeholder: 'Ex : Renault, BMW, MAN, DAF, Mercedes…',
      wreck_step2_bot_question: 'Quel modèle ?',
      wreck_step2_input_placeholder: 'Ex : Clio, Série 3, Actros, XF, TGX…',
      ...
      step5_summary_company: 'A.B.D Dépannage',
    ...
    nl: {
      ...
      step0_bot_message: 'Dag! We zijn 24/7 beschikbaar. Beschrijf uw probleem en we geven u een prijs op WhatsApp, zonder verplichting.',

      problem_poidslourd: 'Vrachtwagen / zwaar voertuig defect',

      // PTAC opties (vrachtwagengewichtsklasse)
      ptac_3_5t: 'Tot 3,5T',
      ptac_7_5t: '3,5 tot 7,5T',
      ptac_12t: '7,5 tot 12T',
      ptac_19t: '12 tot 19T',
      ptac_26t: '19 tot 26T',
      ptac_32t: '26 tot 32T',
      ptac_40t: 'Oplegger 40T',
      ptac_over40t: 'Meer dan 40T',
      summary_ptac: 'MTM',
      msg_ptac: 'MTM:',
      ...
      problem_locked: 'Ik ben buitengesloten uit mijn auto',
      problem_other: 'Ander probleem',

      response_poidslourd: 'We hebben een zware sleepwagen 24/7, snelwegbeveiligingsvoertuig en aangepast materiaal (MTM tot 40T). Wat info over uw voertuig voor de prijs.',
      ...
      response_locked: 'We komen uw auto openen met de niet-destructieve kit — geen kapot raam, geen schade. Wat info over uw voertuig voor de prijs.',
      ...
      // Step 1b: Wheel position (flat tire only)
      step1b_bot_question: 'Welk wiel is lek?',
      wheel_position_front: 'Voorwiel',
      wheel_position_rear: 'Achterwiel',

      // Step Wreck / Locked / Vrachtwagen: Vehicle identification (brand, model, year)
      wreck_step1_bot_question: 'Wat is het merk van het voertuig?',
      wreck_step1_input_placeholder: 'Bv.: Renault, BMW, MAN, DAF, Mercedes…',
      wreck_step2_bot_question: 'Welk model?',
      wreck_step2_input_placeholder: 'Bv.: Clio, Serie 3, Actros, XF, TGX…',
      wreck_step3_bot_question: 'Welk jaar?',
      wreck_step3_input_placeholder: 'Bv.: 2018',
  ...
  // Translations inline only (no external JSON to fetch for ABD).
  ...
  const PROBLEMS = [
    { id: 'poidslourd', needsDestination: true },
  ...
  // PTAC options for poids lourd (heavy truck)
  const PTAC_OPTIONS = [
    { id: '3_5t', label: 'Jusqu\'à 3,5T' },
    { id: '7_5t', label: '3,5 à 7,5T' },
    { id: '12t',  label: '7,5 à 12T' },
    { id: '19t',  label: '12 à 19T' },
    { id: '26t',  label: '19 à 26T' },
    { id: '32t',  label: '26 à 32T' },
    { id: '40t',  label: 'Semi 40T' },
    { id: 'over40t', label: 'Plus de 40T' }
  ];
  ...
  const ICONS = {
    ...
    bigTruck: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="1" y="6" width="13" height="9"></rect><path d="M14 9h5l3 3v3h-8z"></path><circle cx="5" cy="18" r="2"></circle><circle cx="11" cy="18" r="2"></circle><circle cx="19" cy="18" r="2"></circle></svg>`,
      ...
      <div class="wa-header-v5">
        <div class="wa-header-left">
          <div class="wa-header-avatar">
            <img src="${getLogoPath()}" alt="ABD Depannage logo" class="wa-header-logo" />
          </div>
  ...
  // Helper: Get path to ABD logo for the WhatsApp chat avatar.
  // Site is FR-only (no /en/ version), one logo for everyone.
  function getLogoPath() {
    return 'images/logo-abd.jpg';
  }
    ...
    return `
      <div class="wa-message wa-bot-message wa-fade-in">
        <div class="wa-bot-avatar">
          <img src="${getLogoPath()}" alt="ABD" class="wa-bot-logo" />
        </div>
  ...
  // Heavy truck (poids lourd) flow - Step 1 : PTAC selection
  function createPoidsLourdStep1() {
    let html = '';

    if (state.problem && state.problem.id === 'poidslourd') {
      // User message with chosen problem
      html += createUserMessage(t('problem_' + state.problem.id));
      ...
      // Bot response + PTAC options
      else if (state.currentStep === 1 && !state.isTyping) {
        html += createBotMessage(t('response_poidslourd'));
        html += `<div class="wa-options-container wa-options-delayed">`;
        PTAC_OPTIONS.forEach(opt => {
          html += createOptionButton(
            opt.id,
            ICONS.bigTruck,
            t('ptac_' + opt.id)
      ...
      // Next steps : show user PTAC choice
      else if (state.currentStep > 1 && state.ptac) {
        html += createUserMessage(t('ptac_' + state.ptac));
      }
    }
  ...
  function createWreckStep1() {
    ...
    if (state.problem && (state.problem.id === 'wreck' || state.problem.id === 'locked')) {
      // Afficher la bulle utilisateur avec le problème choisi
      html += createUserMessage(t('problem_' + state.problem.id));
      ...
      // Pour les étapes suivantes (> 1), afficher seulement la réponse de l'utilisateur
  ...
  function createWreckStep2() {
    ...
    if (state.vehicleBrand && state.problem && (state.problem.id === 'wreck' || state.problem.id === 'locked')) {
      ...
      // Pour les étapes suivantes (> 2), afficher seulement la réponse de l'utilisateur
  ...
  function createWreckStep3() {
    ...
    if (state.vehicleModel && state.problem && (state.problem.id === 'wreck' || state.problem.id === 'locked')) {
      ...
      // Pour les étapes suivantes (> 3), ne rien afficher ici car createStep4() gère l'affichage de l'année
      // (removed to prevent duplicate year display)
    }
  ...
  function createStep2() {
    ...
    if (state.wheelPosition && state.problem && state.problem.id === 'flat') {
      log('DEBUG createStep2 flat tire ENTRY', {
      ...
      // Si on est en train de "taper", afficher SEULEMENT l'indicateur
      if (state.isTyping && state.currentStep === 2) {
        log('DEBUG createStep2 flat tire: showing typing indicator');
        html += createTypingIndicator();
      }
      // Sinon, afficher le message du bot et les options (mais pas pendant le typing)
      else if (state.currentStep >= 2 && !state.isTyping) {
        log('DEBUG createStep2 flat tire: showing bot message');
        html += createBotMessage(t('step2_bot_question'));

        // Afficher les options SEULEMENT si on est exactement à l'étape 2
        if (state.currentStep === 2) {
          log('DEBUG createStep2 flat tire: rendering transmission options');
          html += `<div class="wa-small-options-container wa-options-delayed">`;
          TRANSMISSIONS.forEach(trans => {
            const icon = trans.id === 'manual' ? ICONS.settings2 : ICONS.cog;
            html += createSmallOptionButton(
          ...
          log('DEBUG createStep2 flat tire: NOT step 2, step is', state.currentStep);
        }
      } else {
        log('DEBUG createStep2 flat tire: condition not met', {
          'currentStep >= 2': state.currentStep >= 2,
          '!isTyping': !state.isTyping
        });
      }
    }
  ...
  function createStep4() {
    ...
    const isPoidsLourd = state.problem?.id === 'poidslourd';
    const shouldShowStep4 = isWreck ? state.vehicleYear : (isPoidsLourd ? state.ptac : (state.fourWheelDrive !== null));
    ...
    if (shouldShowStep4) {
      ...
      // Afficher le message du bot SEULEMENT si on est exactement à l'étape 4
          ...
          if (!state.showAddressInput) {
            ...
            html += `
              <div class="wa-address-input-container">
                <form id="wa-address-form" class="wa-address-input-row" onsubmit="return false;">
                  ...
                  <button class="wa-address-submit-btn" id="wa-address-submit" type="submit" aria-label="Valider l'adresse">
                    ${ICONS.chevronRight}
                  </button>
                </form>
                <div id="wa-address-suggestions"></div>
                <button class="wa-back-link" id="wa-address-back" type="button">
                  ${t('step4_back_btn')}
                </button>
              </div>
            `;
      ...
      // Pour les étapes suivantes (> 4), afficher la bulle utilisateur "Localisation partagée"
  ...
  function createStep4b() {
    ...
    if (state.location.type) {
      // Afficher "Localisation partagée" au lieu de l'adresse complète
      html += createUserMessage(t('location_shared'));

      // Afficher le message de destination de l'utilisateur si on est au-delà de step 5
      ...
      // Only show the bot message and options if we're exactly at step 5 (not beyond)
      if (state.currentStep === 5) {
        ...
        if (!state.showDestinationInput) {
          ...
          // Show address input with autocomplete (only if still at step 5)
          html += `
            <div class="wa-address-input-container">
              <form id="wa-destination-form" class="wa-address-input-row" onsubmit="return false;">
                <div class="wa-input-wrapper">
                  ${ICONS.search}
                  <input
                    type="text"
                ...
                <button class="wa-address-submit-btn" id="wa-destination-submit" type="submit" aria-label="Valider la destination">
                  ${ICONS.chevronRight}
                </button>
              </form>
  ...
  function createStep5() {
    ...
    if (finalCondition) {
      // Ne pas afficher le message utilisateur ici pour needsDestination
      // car createStep4b() affiche déjà "Localisation partagée"
  ...
  function createSummaryCard() {
    ...
    // Different summary for wreck removal and locked door (marque/modèle/année)
    const isWreck = state.problem.id === 'wreck' || state.problem.id === 'locked' || state.problem.id === 'poidslourd';

    return `
      <div class="wa-summary-card">
        <div class="wa-summary-header">
          <div class="wa-summary-avatar">
            <img src="${getLogoPath()}" alt="ABD Depannage logo" class="wa-summary-logo" />
          </div>
          <div>
        ...
        <div class="wa-summary-items">
          ...
          ${state.problem.id === 'poidslourd' ? `
            <div class="wa-summary-item">
              <span class="wa-summary-label">
                ${ICONS.bigTruck}
                ${t('summary_ptac')}
              </span>
              <span class="wa-summary-value">${t('ptac_' + state.ptac)}</span>
            </div>
          ` : `
            <div class="wa-summary-item">
              <span class="wa-summary-label">
          ...
          ${!isWreck && state.problem.id !== 'poidslourd' ? `
            <div class="wa-summary-item">
              <span class="wa-summary-label">
                ${ICONS.settings2}
  ...
  function renderCurrentStep() {
    ...
    // Heavy truck flow : PTAC selection (step 1) → location (step 4) → destination (step 5) → summary (step 6)
    if (state.problem?.id === 'poidslourd') {
      if (state.currentStep >= 1) html += createPoidsLourdStep1();
    ...
    // Wreck removal / locked door flow : marque → modèle → année → location → summary
    else if (state.problem?.id === 'wreck' || state.problem?.id === 'locked') {
  ...
  function goToNextStep() {
    ...
    setTimeout(() => {
      ...
      // Si on vient d'atteindre l'étape finale, montrer le récapitulatif après 4 secondes
      const finalStep = state.problem?.needsDestination ? 6 : 5;
      if (state.currentStep === finalStep) {
        setTimeout(() => {
          ...
          renderCurrentStep();
          smoothScrollToBottom();
        }, 4000); // Attendre 4 secondes avant de montrer le récap
      } else {
  ...
  function attachStepEvents() {
    ...
    allOptionBtns.forEach(btn => {
      btn.addEventListener('click', () => {
        ...
        // Heavy truck flow : option is a PTAC code; jump directly to step 4 (location)
        if (state.problem?.id === 'poidslourd' && state.currentStep === 1) {
          state.ptac = optionId;
          log('PTAC selected', state.ptac);
          setTimeout(() => {
            state.currentStep = 4;
            state.isTyping = true;
            renderCurrentStep();
    ...
    // Wreck removal: Brand input (Step 1) with autocomplete
    ...
    document.querySelectorAll('.wa-small-options-container .wa-small-option-btn').forEach(btn => {
      btn.addEventListener('click', () => {
        ...
        if (state.currentStep === 1.5) {
          ...
          // Special case: after step 1.5, go to step 2 (not 2.5)
          state.currentStep = 2;
          state.isTyping = true;
          renderCurrentStep();
          smoothScrollToBottom();
    ...
    // Manual address submission (form submit covers Enter on iOS Safari + button click)
    const addressForm = document.getElementById('wa-address-form');
    ...
    if (addressForm && addressInput) {
      ...
      const submitAddress = (e) => {
        ...
        log('Address submit attempted, value =', value);
        if (value.length >= 2) {
      ...
      // Fallback for browsers that do not fire submit on the button
      const addressSubmitBtn = document.getElementById('wa-address-submit');
      if (addressSubmitBtn) {
        addressSubmitBtn.addEventListener('click', submitAddress);
      }
    ...
    const destForm = document.getElementById('wa-destination-form');
    if (destForm && destInput) {
      let destSubmitted = false;
      const submitDest = (e) => {
        if (e && e.preventDefault) e.preventDefault();
        if (destSubmitted) return;
        const value = (destInput.value || '').trim();
        log('Destination submit attempted, value =', value);
        if (value.length >= 2) {
          destSubmitted = true;
          destInput.blur();
      ...
      destForm.addEventListener('submit', submitDest);
      const destSubmitBtn = document.getElementById('wa-destination-submit');
      if (destSubmitBtn) {
        destSubmitBtn.addEventListener('click', submitDest);
      }
  ...
  function handleGPSLocation() {
    ...
    navigator.geolocation.getCurrentPosition(
      ...
      (error) => {
        ...
        // Initialize Google Places autocomplete after showing the address input
        setTimeout(() => {
          const input = document.getElementById('wa-address-input');
          if (input) input.focus();
          initGooglePlaces('wa-address-input', 'wa-address-suggestions', handleAddressSelect);
  ...
  function calculateDistance() {
    ...
    directionsService.route({
      ...
      travelMode: 'DRIVING',
      drivingOptions: {
        departureTime: new Date(),  // Utilise le trafic actuel
        trafficModel: 'bestguess'    // Meilleure estimation du trafic
      }
    }, (result, status) => {
      if (status === 'OK' && result.routes[0]) {
        const leg = result.routes[0].legs[0];
        state.destination.distance = leg.distance.text;
        // Utilise duration_in_traffic si disponible (avec trafic), sinon duration standard
        state.destination.duration = leg.duration_in_traffic
          ? leg.duration_in_traffic.text
          : leg.duration.text;

        log('Distance calculated with traffic', state.destination);
  ...
  function buildWhatsAppMessage() {
    ...
    // Different message format for wreck removal, locked door, and heavy truck
    if (state.problem.id === 'poidslourd') {
      msg += `${t('msg_ptac')} ${t('ptac_' + state.ptac)}\n`;
    } else if (state.problem.id === 'wreck' || state.problem.id === 'locked') {
  ...
  function injectStyles() {
    ...
    style.textContent = `
      ...
      .wa-urgent-tag {
        ...
        gap: 0.5rem;
        padding: 0.625rem 1rem;
        background: linear-gradient(135deg, #F5C518 0%, #D9AC00 100%);
        border: none;
        border-radius: 25px;
      ...
      .wa-urgent-tag:hover {
        background: linear-gradient(135deg, #D9AC00 0%, #A8870A 100%);
        transform: translateY(-2px);
      ...
      .wa-address-input-row {
        display: flex;
        align-items: stretch;
        gap: 0.5rem;
      }

      .wa-address-input-row .wa-input-wrapper {
        flex: 1 1 auto;
        min-width: 0;
      }

      .wa-address-submit-btn {
        flex: 0 0 auto;
        width: 52px;
        min-height: 52px;
        padding: 0;
      ...
      .wa-address-submit-btn:hover { background: #D9AC00; }
      .wa-address-submit-btn:active { transform: scale(0.96); }
      .wa-address-submit-btn svg { width: 24px; height: 24px; }
      ...
      .wa-autocomplete-item:last-child {
        border-bottom: none;
      }

      .wa-autocomplete-item:hover {
        background-color: rgba(59, 130, 246, 0.08);
        color: #2563eb;
      }

      .wa-autocomplete-item:active {
